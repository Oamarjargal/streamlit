...
start_HRP = st.file_uploader("Upload Start HRP Map ", type=["tif", "tiff"])
midpoint_HRP = st.file_uploader("Upload Midpoint HRP Map ", type=["tif", "tiff"])
end_HRP = st.file_uploader("Upload End HRP Map ", type=["tif", "tiff"])
...
#upload TIFF file
uploaded_file = st.file_uploader("Upload FCBM here", type=["tif"])
